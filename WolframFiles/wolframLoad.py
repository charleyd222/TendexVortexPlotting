...
if __name__ == "__main__":
    wolfram_equation = "{{(-105*x^4)/(x^2 + y^2 + z^2)^(9/2) + (105*x^2*y^2)/(x^2 + y^2 + z^2)^(9/2) + (75*x^2)/(x^2 + y^2 + z^2)^(7/2) - (15*y^2)/(x^2 + y^2 + z^2)^(7/2) - 6/(x^2 + y^2 + z^2)^(5/2) - w^4/Sqrt[x^2 + y^2 + z^2] - w^2*((6*x^2)/(x^2 + y^2 + z^2)^(5/2) - 2/(x^2 + y^2 + z^2)^(3/2)) - w^2*((-3*z^2)/(x^2 + y^2 + z^2)^(5/2) + (x^2 + y^2 + z^2)^(-3/2)), 0. - (105*x^3*y)/(x^2 + y^2 + z^2)^(9/2) + (105*x*y^3)/(x^2 + y^2 + z^2)^(9/2), 0. - (105*x^3*z)/(x^2 + y^2 + z^2)^(9/2) + (105*x*y^2*z)/(x^2 + y^2 + z^2)^(9/2) + (30*x*z)/(x^2 + y^2 + z^2)^(7/2) - (6*w^2*x*z)/(x^2 + y^2 + z^2)^(5/2)}, {0. - (105*x^3*y)/(x^2 + y^2 + z^2)^(9/2) + (105*x*y^3)/(x^2 + y^2 + z^2)^(9/2), (-105*x^2*y^2)/(x^2 + y^2 + z^2)^(9/2) + (105*y^4)/(x^2 + y^2 + z^2)^(9/2) + (15*x^2)/(x^2 + y^2 + z^2)^(7/2) - (75*y^2)/(x^2 + y^2 + z^2)^(7/2) + 6/(x^2 + y^2 + z^2)^(5/2) + w^4/Sqrt[x^2 + y^2 + z^2] - w^2*((3*z^2)/(x^2 + y^2 + z^2)^(5/2) - (x^2 + y^2 + z^2)^(-3/2)) - w^2*((-6*y^2)/(x^2 + y^2 + z^2)^(5/2) + 2/(x^2 + y^2 + z^2)^(3/2)), 0. - (105*x^2*y*z)/(x^2 + y^2 + z^2)^(9/2) + (105*y^3*z)/(x^2 + y^2 + z^2)^(9/2) - (30*y*z)/(x^2 + y^2 + z^2)^(7/2) + (6*w^2*y*z)/(x^2 + y^2 + z^2)^(5/2)}, {0. - (105*x^3*z)/(x^2 + y^2 + z^2)^(9/2) + (105*x*y^2*z)/(x^2 + y^2 + z^2)^(9/2) + (30*x*z)/(x^2 + y^2 + z^2)^(7/2) - (6*w^2*x*z)/(x^2 + y^2 + z^2)^(5/2), 0. - (105*x^2*y*z)/(x^2 + y^2 + z^2)^(9/2) + (105*y^3*z)/(x^2 + y^2 + z^2)^(9/2) - (30*y*z)/(x^2 + y^2 + z^2)^(7/2) + (6*w^2*y*z)/(x^2 + y^2 + z^2)^(5/2), 0. - (105*x^2*z^2)/(x^2 + y^2 + z^2)^(9/2) + (105*y^2*z^2)/(x^2 + y^2 + z^2)^(9/2) + (15*x^2)/(x^2 + y^2 + z^2)^(7/2) - (15*y^2)/(x^2 + y^2 + z^2)^(7/2) - w^2*((3*y^2)/(x^2 + y^2 + z^2)^(5/2) - (x^2 + y^2 + z^2)^(-3/2)) - w^2*((-3*x^2)/(x^2 + y^2 + z^2)^(5/2) + (x^2 + y^2 + z^2)^(-3/2))}}"
