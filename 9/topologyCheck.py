...
# RKA setup
seed_its = 20 # Iterations per seed point
...
title, x_seeds_bound, y_seeds_bound, z_seeds_bound = seed(6, (bound_seed_sizeX, bound_seed_sizeY), 
                                                  bound_seeds, (bound_seed_center_X, bound_seed_center_Y))

show_full = True

title, x_seeds, y_seeds, z_seeds = seed(4, distance, seed_num)
#title, x_seeds, y_seeds, z_seeds = seed(7, num=seed_num, xLim=(0,-3), yLim = (0,-3))
#plt.scatter(x_seeds, y_seeds)
#plt.show()
seeds = len(x_seeds)
