...
rka_iter.argtypes = [c_double, c_double, c_double, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_double]
...
for i in range(seeds):
    ...
    for icity in [-1]:
        for factor in [-1,1]:
            ...
            vect_c = rka_iter(x, y, z, num_its, icity, ending_tolerance, delta_0, safety, h0, w, factor, dist*1.5)
